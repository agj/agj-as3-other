package cl.agj.search.google.image {
	...
	public class GoogleImageRetriever extends EventDispatcher {
		...
		public function search(query:String, startAtResult:uint = 0):void {
			var ism:ImageSearchManager = new ImageSearchManager;
			//ism.resultsObtained.add();
			ism.search(query, startAtResult);
		}
