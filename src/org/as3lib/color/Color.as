package org.as3lib.color
{
	...
	public class Color extends EventDispatcher
	{
		...
		public function set hex (rgb:uint):void { 
			rgb = limit(rgb, 0, MAX_COLOR_VALUE);
			_hex = rgb; 
		...
		public function isGrey():Boolean { 
			return lightestChannelValue == darkestChannelValue; 
			// note: his implies that the middle channel value is equal too because
			// it must be in-between the darkest and lightest which are the same. 
		}
